...
Di sini program akan dijalankan jika pengguna menginput angka 5 dan angka diluar 1-5, program menjalanan fungsi untuk menampilkan kalimat bahwa program berakhir atau keluar
